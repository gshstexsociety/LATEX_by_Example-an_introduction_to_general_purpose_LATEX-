...
\begin{document}
	...
	\begin{flushright}
		...
		\LARGE {\onehalfspacing  An Introdusction To }
	...
	\begin{flushright}
		\vfill \LARGE 경기과학고등학교 \TeX 사용자 협회 지음
	\end{flushright}
	...
	\begin{tabularx}{\textwidth \large \onehalfspacing}{|X|X|}
		...
		\hline
		\textbackslash int\_0\textasciicircum \textbackslash infty x\textbackslash ,dx& \(\int_{0}^{\infty}x\,dx \)\\
		\hline
		\textbackslash frac\{d\}\{dx\} \textbackslash big( k f(x) \textbackslash big)&\(\frac{{d}}{ dx}\big( k g(x) \big) \)\\
		\hline
